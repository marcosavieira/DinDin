        ...
        <div className="container-login">
            ...
            <div className="navs-login">
                <div className="login-description-cadastro">
                    <h1>
                        Controle suas <span id="span">finanças</span>, sem
                        planilha chata.
                    </h1>

                    <h2>
                        Organizar as suas finanças nunca foi tão fácil, com o
                        DINDIN, você tem tudo num único lugar e em um clique de
                        distância.
                    </h2>
